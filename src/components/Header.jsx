...
export default function Header() {
  ...
  return (
    <header className="w-full bg-white shadow-sm sticky top-0 z-50">
      {/* Top Info Bar */}
      <div className="bg-[#FB7701] text-white py-2 text-center text-xs font-medium px-4">
        ...
        <div className="flex items-center justify-between h-20 gap-4">
          ...
          <Link to="/" className="flex items-center gap-3 shrink-0">
            ...
            <div className="flex flex-col leading-none">
              <span className="text-2xl font-black tracking-tighter text-gray-900 font-['Outfit']">
                GLOBAL
              </span>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            <select 
              ...
              className="text-xs font-bold bg-transparent outline-none cursor-pointer border rounded-md px-1 py-1"
            >
            ...
            <Link to="/products" className="hidden sm:block">
              <Button variant="ghost" className="text-sm font-semibold">
                {language === 'tr' ? 'Tüm Ürünler' : 'Tous les Produits'}
              </Button>
            </Link>
